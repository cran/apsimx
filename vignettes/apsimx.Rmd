...
**Mac**: ApsimX version (2026-06) 8057 (R 4.5.2)

**Debian**: ApsimX version (2024-02) 7382 (R 4.1.2)

**Windows**: ApsimX version (2026-06) 8057 and APSIM Classic 7.10-r4221 (R 4.5.3)
...
Environmental Mesonet (mesonet.agron.iastate.edu). In addition, this package provides the following utilities:
